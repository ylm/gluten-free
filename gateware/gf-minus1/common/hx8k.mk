...
%.json: $(SYN_FILES_REL) $(INC_FILES_REL)
	...
	yosys -p "scratchpad -copy abc9.script.flow3 abc9.script; synth_ice40 -device hx -abc9 -dff -json $@ -top $(FPGA_TOP)" $(SYN_FILES_REL) defines.v


%.asc: %.json $(PCF_FILES_REL) $(CLK_FILES_REL)
	$(NEXTPNR) $(NEXTPNR_ARGS) --$(DEVICE) --asc $@ --pcf $(PCF_FILES_REL) --json $(PROJ).json --package ct256 --pre-pack $(CLK_FILES_REL)
